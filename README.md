...
- 本论文是基于NVIDIA的OCRNet_msacle-HRNetV2_W48模型，[预训练模型]([drive.google.com](https://drive.google.com/open?id=1fs-uLzXvmsISbS635eRZCc5uzQdBIZ_U))同样来源于OCRNet_msacle-HRNetV2_W48模型的预训练模型——在Mappilary数据集上训练200个epoch得到的模型，并将Pytorch的.pth文件转化为Paddle的.pdparams文件，训练时放置的位置见[第6部分代码详细结构说明](#  6. 代码详细结构说明)。
